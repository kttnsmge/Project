...
no_account_button = Button(canvas1, text="SIGN UP NOW", fg="white",bg="brown", font=("Lucida Sans",13,"bold"),activebackground="brown")
no_account_button.place(x=530, y=480)
